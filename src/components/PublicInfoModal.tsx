 ...
 * Mounted once in `App.tsx` and driven by a global signal, needed here
 * because unlike every other detail modal in this repo
 * (`ContractDetailModal`, `ItemDetailModal`), this one is opened from several
 * unrelated features rather than one route that already owns local `selected`
 * state.
 *
