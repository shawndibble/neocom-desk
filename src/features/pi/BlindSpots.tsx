      ...
      <ul className="space-y-1.5">
        {spots.map((spot) => (
          <li key={spot.key} className="flex items-baseline gap-2.5">
            <span className="inline-flex h-[1.125rem] shrink-0 items-center rounded-xs border border-transparent bg-panel-2 px-1.5 text-[0.6875rem] font-semibold tracking-widest text-text-dim uppercase">
