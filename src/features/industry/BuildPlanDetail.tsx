...
export function BuildPlanDetail({
  ...
  const ownedSale = useMemo(() => {
    ...
    return {
      instant: ownedStockSale(materials, snapshot.hubBuyPrices, 'instant', skills, standing),
      order: ownedStockSale(materials, snapshot.hubPrices, 'order', skills, standing),
    };
  }, [result, snapshot, skills, standing]);
