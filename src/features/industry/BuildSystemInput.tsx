...
/**
 * Names the system the job runs in, which is the system the job fee's cost
 * index is charged at.
 *
 ...
 */
export function BuildSystemInput({ systemName, hubSystemName, onChange }: BuildSystemInputProps) {
