...
| `Select`          | ✓      | Radix listbox (ADR 0004): focus movement, typeahead, roving tabindex. `SelectTrigger` takes the same `size` as every other control.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
