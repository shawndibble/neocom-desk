...
- **"This device" is no longer a section. Its one action, Log out of all characters, is a card at the bottom of Data & storage,** titled "Log out". Behaviour is unchanged (`20260925-084119`).
