...
| `src/lib`                                          | Small pure formatters shared across features with no other natural home: `duration.ts` (`formatDuration`, "Xd Yh Zm")                                                                                                                                                                                                                                                                                                                                                                                                                                               | Feature-specific logic (that belongs in the feature or `engine`)                                                                     | `features/industry`, `features/skills/planner`                           |
