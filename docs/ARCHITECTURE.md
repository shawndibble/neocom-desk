...
| `src/components/ui`                                | Design-system primitives (`Panel`, `Button`, `StatChip`, `DataAgeBadge`, `EmptyState`, `Tabs`, `Spinner`, `Tooltip`/`InfoTooltip`, `ReauthBanner`, `Modal` (native `<dialog>`), `SkillBar`) per `docs/DESIGN.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Feature logic, direct ESI/Dexie calls                                                                                                | every route/feature                                                      |
...
| `src/lib`                                          | Small pure formatters shared across features with no other natural home: `duration.ts` (`formatDuration`, "Xd Yh Zm"), `isk.ts` (`formatIsk(value, decimals = 0)` — clamps float noise so a near-zero value never renders `-0`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Feature-specific logic (that belongs in the feature or `engine`)                                                                     | `features/industry`, `features/skills/planner`                           |
...
| `src/routes`                                       | One file per page: `Login`, `Callback`, `Characters`, `Overview` (+ `overviewQueue.ts`), `Skills`, `SkillPlans`, `Industry`, `Market`, `Wallet`, `Assets`, `Mail`, `Calendar`, `Contracts`, `Orders`, `Styleguide`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Own reusable logic other routes need — push into `features`/`engine`                                                                 | `app/App.tsx` (route table) only                                         |
